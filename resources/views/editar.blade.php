                            ...
                            <p>
                                <form method="post" action="/atualizar/{{$agendamento->id}}" id="form" name="form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{$agendamento->Nome}}" name="txtNome" required id="txtNome">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1">Telefone:</label>
                                        <input type="tel" class="form-control" value="{{$agendamento->Telefone}}" required name="txtTelefone" id="txtTelefone" placeholder="(xx)xxxxx-xxxx">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" required value="{{$agendamento->Data_contato}}" name="txtDataContato" id="txtDataContato">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1">Observação</label>
                                        <textarea class="form-control" name="txtObservacao" id="txtObservacao" rows="3">{{$agendamento->Observacao}}</textarea>
                                    </div>
